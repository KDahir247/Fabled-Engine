// Going to defer the camera conversion system (2021-09-08).
...
// use crate::camera::{
// AspectRatio, Camera, ClippingPlane, Fov, FovAxis, Orientation, Perspective,
// Projection, ProjectionCoordinate, ViewPort,
// };
//
...
// ProjectionCoordinate::LeftHandCoordinate);
//
