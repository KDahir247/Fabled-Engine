...
pub const VON_KRIES_INVERSE: Matrix3x3 = Matrix3x3::set(
    Vector3::set(1.8599364, 0.3611914, 0.0),
    Vector3::set(-1.1293816, 0.6388125, 0.0),
    Vector3::set(0.2198974, -0.0000064, 1.0890636),
);
...
pub const BRADFORD_INVERSE: Matrix3x3 = Matrix3x3::set(
    Vector3::set(0.9869929, 0.4323053, -0.0085287),
    Vector3::set(-0.1470543, 0.5183603, 0.0400428),
    Vector3::set(0.1599627, 0.0492912, 0.9684867),
);
...
pub const CIECAM02_INVERSE: Matrix3x3 = Matrix3x3::set(
    Vector3::set(1.0961, 0.4544, -0.0096),
    Vector3::set(-0.2789, 0.4735, -0.0057),
    Vector3::set(0.1827, 0.0721, 1.0153),
);
