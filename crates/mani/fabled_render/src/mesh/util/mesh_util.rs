...
//         .iter()
//         .any(|&vertex| vertex.normal.ne(&[0.0; 4]));
//
...
//         vertex.bi_tangent = [bi_tangent.x, bi_tangent.y, bi_tangent.z,
// vertex.tangent[3]];     }
// }
//
...
//         Indices::U16(indices_u16) => indices_u16.iter().map(|x| *x as
// u32).collect::<Vec<_>>(),         Indices::U32(indices_u32) =>
// indices_u32.to_owned(),     };
//
...
//         let no = e1.cross(e2);
//
//         let mut a_normal = glam::Vec3A::ZERO;
//         let mut b_normal = glam::Vec3A::ZERO;
//         let mut c_normal = glam::Vec3A::ZERO;
//
//         match instruction {
...
//         }
//
//         mesh.vertices[ia].normal = a_normal.normalize().to_array();
//         mesh.vertices[ib].normal = b_normal.normalize().to_array();
//         mesh.vertices[ic].normal = c_normal.normalize().to_array();
//     }
// }
//
//
...
//         vertices_data[i].tangent = [tangent.x, tangent.y, tangent.z,
// handedness];     }
// }
