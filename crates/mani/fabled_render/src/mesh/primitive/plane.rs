...
//     ) -> Plane {
//         // Sanity check for the size of tesselation_width and
// tessellation_height.         // Prevent increasing tessellation_height and
// tessellation_width intentional or         // unintentional to the point where
// it causes repeating KiPageFault and         // MmAccessFault resulting in
// cache thrashing or memory can't be         // allocated error.
//         //
//         // Unity's plane mesh width and height tessellation caps at 10 width
// x 10         // height.
//         //
//         // If the end user want more tesselation on the plane create another
// plane and         // align it with the previous plane.
//
...
//         let num_triangles =
//             tessellation_width * (tessellation_height << 1) * 3 *
// double_sided_remap as usize;
//
...
//                 let xf = x as f32;
//
//                 // Normal are point in forward side of the plane even on
// double sided and                 // bi_tangent is assume the statement.
//                 vertices.push(Vertex {
//                     position: [xf * scale_x - width * 0.5, 0.0, yf * scale_y
// - height * 0.5],                     tex_coord: [inv_tessellation_width * xf,
// inv_tessellation_height * yf],                     normal: NORMAL_FRONT,
//                     tangent: [0.0; 4],
//                     bi_tangent: [0.0; 4],
//                 });
//             }
...
//     #[test]
//     fn test() {
//         let plane = Plane::new(3.0, 3.0, 10, 10,
// RenderInstruction::DoubleSided);         let plane_model: Model =
// plane.into();         for vertex in &plane_model.meshes[0].vertices {
//             println!(
//                 "new Vector3({}f, {}f, {}f),",
