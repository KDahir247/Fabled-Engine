...
//
// impl UvSphere {
//     pub fn new(radius: f32, tessellation_stack: usize, tessellation_sector:
// usize) -> UvSphere {         Self {
//             radius,
//             tessellation_stack,
//             tessellation_sector,
...
//
//         let vertex_size = uv_sphere.tessellation_stack *
// uv_sphere.tessellation_sector;         let indices_size = (vertex_size << 1)
// * 3;
//
...
//             let stack_angle = std::f32::consts::PI / 2.0 - i as f32 *
// stack_step;             let xy = uv_sphere.radius * stack_angle.cos();
