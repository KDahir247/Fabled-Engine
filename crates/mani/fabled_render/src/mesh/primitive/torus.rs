...
//         let total_vertices = (tessellation_segment + 1) * (tessellation_side
// + 1);
//
...
//                 let (phi_sin, phi_cos) = (u_tex *
// std::f32::consts::TAU).sin_cos();                 let (theta_sin, theta_cos)
// = (v_tex * std::f32::consts::TAU).sin_cos();
//
...
//                 let normal = glam::Vec3A::new(phi_cos * theta_cos, theta_sin,
// phi_sin * theta_cos)                     .normalize();
//
...
//                 // Finding the 4 vertices that makes up the four corner of a
// quad.                 let i1 = current_side_offset + side;
//                 let i2 = current_side_offset + side + 1;
//                 let i3 = next_side_offset + side + 1;
//                 let i4 = next_side_offset + side + 2;
//
//                 let face_indices = [i1 + seg, i2 + seg, i3 + seg, i2 + seg,
// i4 + seg, i3 + seg];
//
//                 {
//                     // memcpy face_indices to 6 * i1 element slice of
// indices.                     let offset = i1 * 6;
