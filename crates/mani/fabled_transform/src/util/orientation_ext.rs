...
//
// NOT tested yet.
// pub fn reflect_orientation(orientation: Orientation, direction:
// AxisDirection) -> Orientation { let direction_i32 = direction as i32;
//
...
// orientation.transform.get_transformation_matrix();
//
...
// ];
//
// let glm_transformation_matrix =
// glam::Mat4::from_cols_array(&transformation_matrix); let (scale, rotation,
// translation) = glm_transformation_matrix.to_scale_rotation_translation();
//
//
